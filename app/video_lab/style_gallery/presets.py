...
PRESET_STYLES: list[dict[str, Any]] = [
    ...
    },
    {
        "route_id": "template_programmatic_render",
        "route_name": "Remotion 动态模板路线",
        "style_id": "remotion_report_stable",
        "style_name": "稳重报告型",
        "description": "沉淀自背景/转场矩阵的报告型默认组合：深色科技背景 + 温和转场，适合信息完整、阅读优先的长报告视频。",
        "capabilities": ["报告型摘要", "稳重科技背景", "温和转场", "阅读优先", "长内容友好"],
        "tags": ["报告型", "稳重", "tech_grid_dark", "slide_fade"],
        "params": {
            "showDataViz": True,
            "accentColor": "#3b82f6",
            ...
            "bgm": {"mode": "generated_ambient", "volume": 0.05, "fadeIn": 1.2, "fadeOut": 1.5},
        },
    },
    {
        "route_id": "template_programmatic_render",
        "route_name": "Remotion 动态模板路线",
        "style_id": "remotion_dashboard_glass_wipe",
        "style_name": "玻璃看板快报",
        "description": "玻璃态 dashboard 背景 + wipe 扫光转场，适合 Benchmark、指标变化、模型对比等数据密度较高的内容。",
        "capabilities": ["玻璃态背景", "扫光转场", "数据看板", "指标突出", "高信息密度"],
        "tags": ["看板", "glass_dashboard", "wipe", "Benchmark"],
        "params": {
            "showDataViz": True,
            "accentColor": "#2563eb",
    ...
    },
    {
        "route_id": "template_programmatic_render",
        "route_name": "Remotion 动态模板路线",
        "style_id": "remotion_deep_space_stack",
        "style_name": "深空卡片栈",
        "description": "深空星云背景 + push 推进转场 + Card Stack 表现范式，适合多信息点报告、资讯合集和阶段性进展。",
        "capabilities": ["深空背景", "卡片栈", "推进转场", "多信息点", "层次感"],
        "tags": ["卡片栈", "deep_space", "push", "多信息点"],
        "params": {
            "showDataViz": True,
            "accentColor": "#38bdf8",
            ...
            "remotionFamily": "card_stack",
            "cardStackPeekFrames": 12,
        },
    },
    {
        "route_id": "template_programmatic_render",
        "route_name": "Remotion 动态模板路线",
        "style_id": "remotion_neon_glitch",
        "style_name": "霓虹故障高能",
        "description": "霓虹电路背景 + glitch 故障转场，适合强风格短视频、科技爆点和需要明显 Remotion 运动感的样片。",
        "capabilities": ["霓虹电路背景", "故障转场", "高能短视频", "强风格", "动态背景"],
        "tags": ["霓虹", "neon_circuit", "glitch", "高能"],
        "params": {
            "showDataViz": True,
            "accentColor": "#ec4899",
            ...
            "backgroundPreset": "neon_circuit",
            "remotionFamily": "data_news",
            "bgm": {"mode": "generated_ambient", "volume": 0.07, "fadeIn": 0.8, "fadeOut": 1.2},
        },
    },
    {
        "route_id": "template_programmatic_render",
        "route_name": "Remotion 动态模板路线",
        "style_id": "remotion_caption_aurora_zoom",
        "style_name": "极光大字叙事",
        "description": "极光动态背景 + zoom blur 场景推进 + Caption Story 大字标题，适合观点摘要、口播短片和情绪化解释。",
        "capabilities": ["极光背景", "大字叙事", "镜头推进", "口播友好", "观点强化"],
        "tags": ["大字", "aurora_blue", "zoom_blur", "叙事"],
        "params": {
            "showDataViz": False,
            "accentColor": "#8b5cf6",
