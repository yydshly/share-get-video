...
def runtime_url_to_path(url_or_path: str) -> Path:
    ...
    Supports:
    - /runtime/video_lab/x.mp4          → runtime/video_lab/x.mp4
    - /assets/video_lab/x.mp4           → runtime/video_lab/x.mp4  (via prefix strip)
    - runtime/video_lab/x.mp4           → runtime/video_lab/x.mp4
    - video_lab/x.mp4                   → runtime/video_lab/x.mp4
    - http://host/runtime/video_lab/x   → runtime/video_lab/x
    - http://host/assets/video_lab/x    → runtime/video_lab/x
    - style_gallery/records/xxx.jsonl   → runtime/style_gallery/records/xxx.jsonl
    ...
    # Default: missing prefix → prepend runtime/
