...
const ROUTES = [
  { id: "local_frame_compose", name: "Pillow 静态卡", styleCount: 3 },
  { id: "template_programmatic_render", name: "Remotion 动效", styleCount: 4 },
  { id: "ai_asset_then_compose", name: "AI 素材 + 合成", styleCount: 3 },
];
